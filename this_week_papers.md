...
1. [[]](https://arxiv.org/abs/) - *Title:
          On Modelling the Surfaces of Celestial Bodies in Quantum Gravity* - Xavier Calmet, Marco Sebastianutti
...
1. [[]](https://arxiv.org/abs/) - *Title:
          Thermal Vacuum Model for Cosmology without Inflaton* - Robert Alicki
...
[New papers last week]({{site.url}}/archived/weekly/pre-prints/2025/11/24/archived_weekly_papers.html)