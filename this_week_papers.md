...
1. [[]](https://arxiv.org/abs/) - *Title:
          Degenerate higher-order scalar-tensor theories in metric-affine gravity* - Hamed Bouzari Nezhad
...
1. [[]](https://arxiv.org/abs/) - *Title:
          Thermodynamic Phase Transitions and Quantum Entropy Corrections in the Simpson-Visser Regular Black Hole* - Vinayak Joshi, Ashok B. Joshi
...
1. [[]](https://arxiv.org/abs/) - *Title:
          Tidal Love numbers for regular black holes* - Rui Wang, Qi-Long Shi, Wei Xiong, Peng-Cheng Li
...
#### **Title:
 ...
 - **Authors:** Luis Rey Díaz-Barrón, Abraham Espinoza-García, Sinuhé Pérez-Payán, José Socorro
 - **Subjects:** Subjects:
...
[New papers last week]({{site.url}}/archived/weekly/pre-prints/2025/12/08/archived_weekly_papers.html)